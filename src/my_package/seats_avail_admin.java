 ...
 */
public class seats_avail_admin extends javax.swing.JFrame {
     ...
     */
    public seats_avail_admin(String a) {
        uname=a;
        initComponents();
        cost=0;
        for(int i=0;i<18;i++)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seats_avail_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seats_avail_admin(args[0]).setVisible(true);
            }
        });
    }
